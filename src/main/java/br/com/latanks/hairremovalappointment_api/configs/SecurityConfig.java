package br.com.latanks.hairremovalappointment_api.configs;

import br.com.latanks.hairremovalappointment_api.filters.JWTFilter;
import br.com.latanks.hairremovalappointment_api.security.CustomAccessDeniedHandler;
import br.com.latanks.hairremovalappointment_api.security.CustomAuthenticationEntryPoint;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, baseUrl + "/appointment/{id}").hasRole("ADMIN")
